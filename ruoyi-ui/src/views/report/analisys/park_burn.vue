    ...
    <template>
      <el-card class="box-card" v-if="loaded" body-style="padding:3px">
        <div slot="header" class="clearfix">
          <span><i class="el-icon-s-platform">园区烧结</i></span>
          ...
          <el-col :span="10">
            <el-card shadow="hover" class="my-card h312" body-style="padding:1px">
              ...
              <div class="text item">
                <template>
                  <el-table
                    :data="parkBurnDayReport.subTable1"
                    style="width: 100%">
                    <el-table-column
                      align="center"
                      width="99"
          ...
          <el-col :span="14">
            <el-card shadow="hover" class="my-card h312" body-style="padding:1px;">
              ...
              <div class="text item">
                <template>
                  <el-table
                    :data="parkBurnDayReport.subTable2"
                    prop="colName"
                    style="width: 100%">
                    <el-table-column
                      align="center"
        ...
        <el-row :gutter="10">
          <el-col :span="10">
            <el-card shadow="hover" class="my-card mt5" body-style="padding:1px">
              ...
              <div class="text item">
                <template>
                  <el-table
                    :data="parkBurnDayReport.subTable6"
                    style="width: 100%">
                    <el-table-column
                      prop="name"
                      align="center"
          ...
          <el-col :span="14">
            <el-card shadow="hover" class="my-card mt5 h180" body-style="padding:1px">
              <div slot="header" class="clearfix">
                <i class="el-icon-s-data"></i>
                <span>脱硫脱销</span>
              </div>
              <div class="text item">
                <template>
                  <el-table
                    :data="parkBurnDayReport.subTable5"
                    style="width: 100%">
                    <el-table-column
                      prop="name"
                      align="center"
          ...
          <el-col :span="24">
            <el-card shadow="hover" class="my-card" body-style="padding:1px">
              ...
              <div class="text item">
                <template>
                  <el-table
                    :data="parkBurnDayReport.subTable3"
                    style="width: 100%">
                    <el-table-column
                      prop="name"
                      align="center"
          ...
          <el-col :span="24">
            <el-card shadow="hover" class="my-card mt5" body-style="padding:1px">
              ...
              <div class="text item">
                <template>
                  <el-table
                    :data="parkBurnDayReport.subTable4"
                    style="width: 100%">
                    <el-table-column
                      align="center"
                      prop="colName"
        ...
        <el-row :gutter="10" class="mt5">
          <el-col :span="12">
            <el-card shadow="hover" class="my-card h160" body-style="padding:1px;">
              <div slot="header" class="clearfix">
                <i class="el-icon-question"></i>
                <span>3#生产记事</span>
              </div>
              <div cass="text item" v-for="t in parkBurnDayReport.subTable7">
                <el-alert
    ...
    loadDayReport() {
      for (let i = 20; i <= 26; i++) {
        ...
        getAnalysisData(this.queryParams).then(response => {
          switch (i){
            case 20:
              this.parkBurnDayReport.subTable1 = response.data
              break;
            case 21:
              this.parkBurnDayReport.subTable2 = response.data
              break;
            case 22:
              this.parkBurnDayReport.subTable3 = response.data
              break;
            case 23:
              this.parkBurnDayReport.subTable4 = response.data
              break;
            case 24:
              this.parkBurnDayReport.subTable5 = response.data
              break;
            case 25:
              this.parkBurnDayReport.subTable6 = response.data
              break;
            case 26:
              this.parkBurnDayReport.subTable7 = response.data
              break;
          }
        });
      }
