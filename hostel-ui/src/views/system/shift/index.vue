<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="shiftList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班次名" align="center" prop="id" />
      <el-table-column label="主表id" align="center" prop="mainTableId" />
      <el-table-column label="班次名" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="主表id" prop="mainTableId">
          <el-input v-model="form.mainTableId" placeholder="请输入主表id" />
        </el-form-item>
        <el-form-item label="班次名" prop="name">
          <el-input v-model="form.name" placeholder="请输入班次名" />
        </el-form-item>
      </el-form>
...
<script>
import { listShift, getShift, delShift, addShift, updateShift, exportShift } from "@/api/system/shift";
